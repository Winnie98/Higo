...
public class PublishAdapter extends MultipleRecyclerAdapter{
...
//    private final DataConverter CONVERTER;
    ...
    private PublishDataConverter mDataConverter = new PublishDataConverter();
    Integer[] promoId;
    ...
    public PublishAdapter(List<MultipleItemEntity> data, HigoDelegate delegate) {
        super(data);
        DELEGATE = delegate;
...
//                    statusText.setText(statusName);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int promoId = mDataConverter.mPublishPromoId.get(position);
