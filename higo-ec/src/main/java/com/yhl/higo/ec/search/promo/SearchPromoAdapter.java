...
public class SearchPromoAdapter extends MultipleRecyclerAdapter{
...
//    private final DataConverter CONVERTER;
    ...
    private SearchPromoDataConverter  mDataConverter = new SearchPromoDataConverter();
    Integer[] promoId;
    ...
    public SearchPromoAdapter(List<MultipleItemEntity> data, HigoDelegate delegate) {
        super(data);
        DELEGATE = delegate;
